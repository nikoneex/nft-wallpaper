    ...
    getProvider() {
        if (!this._baseAlchemyProvider) {
            this._baseAlchemyProvider = (() => __awaiter(this, void 0, void 0, function* () {
                const { AlchemyProvider } = yield import('./alchemy-provider-1b13a2c9.js');
    ...
    getWebSocketProvider() {
        if (!this._baseAlchemyWssProvider) {
            this._baseAlchemyWssProvider = (() => __awaiter(this, void 0, void 0, function* () {
                const { AlchemyWebSocketProvider } = yield import('./alchemy-websocket-provider-70d41746.js');
...
export { Alchemy as A, CustomNetworks as C, DEFAULT_ALCHEMY_API_KEY as D, EthersNetwork as E, IS_BROWSER as I, Network as N, RefreshState as R, VERSION as V, Wallet as W, __awaiter as _, DEFAULT_NETWORK as a, getAlchemyWsUrl as b, AssetTransfersCategory as c, AssetTransfersOrder as d, NftTokenType as e, fromHex as f, getAlchemyHttpUrl as g, NftExcludeFilters as h, isHex as i, logWarn as l, noop as n, setLogLevel as s, toHex as t };
//# sourceMappingURL=index-dddbb41a.js.map
